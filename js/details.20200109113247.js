...
r=function(){dpi=window.devicePixelRatio;$('.js23').attr('src', (dpi>1) ? 'images/5cb7832ca7c7755bf004c148-1078.png' : 'images/5cb7832ca7c7755bf004c148-539.png');
...
wl.addAnimation($('.js27')[0], "1.30s", "0.00s", 1, 100);
wl.start();
